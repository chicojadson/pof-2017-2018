...
setwd("C:\\Users\\jadso.FRANCISCOJADSON\\Documents\\OMT\\POF\\") # indica o diretorio de trabalho 
#setwd("C:\\Users\\omtmaranhao\\Documents\\POF\\")
rm(list = ls())

######################################## 2017-2018 REGISTRO - RENDIMENTO DO TRABALHO ######################################
rendimento_total_var_patrim_2017_2018 <- read_xlsx("Pesquisa_de_Orcamentos_Familiares_2017_2018\\Primeiros_resultados\\tabelas_unidades_da_federacao\\tabelas_unidades_da_federacao_xls\\21MA.xls.xlsx",
                                                   skip = 11,
                                                   sheet = 5,
